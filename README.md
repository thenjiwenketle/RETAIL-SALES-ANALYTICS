...
- Checked and handled missing values (Excel & Power Query)
- Removed duplicate records  (Excel & Power Query)
- Verified and corrected data types  (Power Query)
- Converted Order Date and Ship Date to datetime format  (Excel)
